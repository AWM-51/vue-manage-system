    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-cascades"></i> Mock结果列表
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            ...
            >
                ...
                <el-table-column prop="des" label="结果描述">
                </el-table-column>           
                <el-table-column prop="mres" label="结果值" align="center" show-overflow-tooltip>      
                </el-table-column>
...
export default {
    ...
    methods: {
        // 获取 uri列表 数据
        getData() {
            getMockResList(this.query).then(res => {
                console.log(res);
        ...
        //获取上个页面传过来的参数
        getInfo() {
            this.query.uid=this.$route.query.uid.id;
        },
        ...
        handleClean(){
            ...
            this.$set(this.query, 'offset', 0);
            this.$set(this.query, 'pageSize', 10);
            this.$set(this.query, 'id', null);
            this.$set(this.query, 'des', null);
            this.$set(this.query, 'uri', null);
            this.getData();
        },
        //跳转到下发选择
        chosePushObject(row){
