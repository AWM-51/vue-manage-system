    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-cascades"></i> Mock接口列表
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            ...
            >
                ...
                <el-table-column prop="uri" label="Mock接口名">
                </el-table-column>           
                ...
                <el-table-column label="操作" width="180" align="center">
                    <template slot-scope="scope">
                        ...
                        <el-button
                            ...
                            @click="gotoParamPage(scope.row)"
                        >参数配置</el-button>
                        <el-button
                            type="text"
                            icon="el-icon-circle-plus"
                            @click="gotoResPage(scope.row)"
                        >结果配置</el-button>
                        <el-button
                            type="text"
                            icon="el-icon-delete"
...
<script>
import { getMockUriList } from '@/api/mock';
...
export default {
    ...
    methods: {
        // 获取 uri列表 数据
        getData() {
            getMockUriList(this.query).then(res => {
                console.log(res);
