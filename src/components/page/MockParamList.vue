    ...
    <div>
        ...
        <div class="container">
            ...
            >
                ...
                <el-table-column prop="des" label="参数描述">
                </el-table-column>           
                <el-table-column prop="paramValue" label="参数值" align="center" show-overflow-tooltip>      
                </el-table-column>
                <el-table-column prop="resid" label="对应结果值id" align="center">      
                </el-table-column>
...
<script>
import { getMockParamList } from '@/api/mock';
...
export default {
    ...
    methods: {
        // 获取 uri列表 数据
        getData() {
            getMockParamList(this.query).then(res => {
                console.log(res);
